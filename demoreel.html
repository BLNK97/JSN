...
<html>
    ...
    <body id="work">
        ...
        <div id="content" id="clear">
            <h2 style="padding-top:50px; padding-bottom:10px; font-size:30px;">DEMO REEL</h2>
            <video class="aligncenter" width="560" height="360" controls controlsList="nodownload">
